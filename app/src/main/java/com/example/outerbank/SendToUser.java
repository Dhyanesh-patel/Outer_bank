...
public class SendToUser extends AppCompatActivity {
    ...
    com.example.outerbank.CustomeAdapterSendToUser adapter;
    ...
    private void showData(String phonenumber) {
        ...
        adapter = new com.example.outerbank.CustomeAdapterSendToUser(com.example.outerbank.SendToUser.this, modelList_sendtouser);
    ...
    public void selectuser(int position) {
        ...
        while(cursor.moveToNext()) {
            ...
            startActivity(new Intent(com.example.outerbank.SendToUser.this, Userlist.class));
            finish();
        }
    }
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(com.example.outerbank.SendToUser.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new DatabaseHelper(com.example.outerbank.SendToUser.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
                        Toast.makeText(com.example.outerbank.SendToUser.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(com.example.outerbank.SendToUser.this, Userlist.class));
                        finish();
                    }
